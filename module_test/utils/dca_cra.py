...
from module_test.squeeze_and_excitation import *
# from module_test.PSA import *
from module_test.STAR import *
from module_test.SEBlock import *
from module_test.AMSCM import *
from module_test.ms_dilated_attn import *
from module_test.se_conv import *
...
class CCSABlock(nn.Module):
    ...
    def channel_attention(self, x):
        ...
        x_att = self.m_apply(x, self.c_attention)
        return x_att
